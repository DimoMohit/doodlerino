...
RSpec.describe 'Doodles', type: :request do
  ...
  before do
    ...
    # { "top": { "x": 10, "y": 20 }, "bottom": { "x": 10, "y": 20 } }
    get '/canvas?q=%7B%22top%22%3A%7B%22x%22%3A10%2C%22y%22%3A20%7D%2C%22bottom%22%3A%7B%22x%22%3A10%2C%22y%22%3A20%7D%7D'
  end
  ...
  it 'does not show doodles outside the required section' do
    expect(response.body).to include('Bad doodle')
  end
end
